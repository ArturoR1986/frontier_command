...
const hours=Math.max(1,Math.min(48,Number(process.argv.find(a=>a.startsWith('--hours='))?.split('=')[1])||8));
let stopped = false;
for (let i = 0; i < hours*1800; i++) {
